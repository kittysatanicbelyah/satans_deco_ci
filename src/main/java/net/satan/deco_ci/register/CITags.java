...
public class CITags {
    ...
    private static TagKey<Item> tag(String name) {return ItemTags.create(ResourceLocation.fromNamespaceAndPath(satans_deco_ci.MODID, name));}
    }
    ...
    public static class CIBlocks {
        ...
        private static TagKey<Block> tag(String name) {
            return BlockTags.create(ResourceLocation.fromNamespaceAndPath(satans_deco_ci.MODID, name));
        }
    }
    ...
    public static class CommonItems {
        ...
        private static TagKey<Item> tag(String name) {return ItemTags.create(ResourceLocation.fromNamespaceAndPath("c", name));}
    }
}
