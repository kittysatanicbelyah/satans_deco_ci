...
public class CIRecipeProvider extends RecipeProvider implements IConditionBuilder {
    public CIRecipeProvider(CompletableFuture<HolderLookup.Provider> registries, PackOutput packOutput) {
    ...
    protected static void SolidWoolMaking (RecipeOutput recipe, RecipeCategory category, ItemLike result,
    ...
    protected static void SolidWoodMaking (RecipeOutput recipe, RecipeCategory category, ItemLike result,
                                       ItemLike ingredient) {
    ...
    protected static void CarvedMaking (RecipeOutput recipe, RecipeCategory category, ItemLike result,
                                           ItemLike ingredient) {
    ...
    protected static void SoftMaking (RecipeOutput recipe, RecipeCategory category, ItemLike result,
                                           ItemLike ingredient, ItemLike dye) {
    ...
    protected static void OrnateMaking (RecipeOutput recipe, RecipeCategory category, ItemLike result,
    ...
    protected static void OrnateTinselMaking (RecipeOutput recipe, RecipeCategory category, ItemLike result,
    ...
    protected static void edgeTrimMaking (RecipeOutput recipe, RecipeCategory category, ItemLike result,
    ...
    protected static void defaultMaking (RecipeOutput recipe, RecipeCategory category, ItemLike result,
                                          ItemLike ingredient, ItemLike dye) {
    ...
    protected static void blindsMaking (RecipeOutput recipe, RecipeCategory category, ItemLike result,
    ...
    protected static void beadedMaking (RecipeOutput recipe, RecipeCategory category, ItemLike result,
                                         ItemLike ingredient, ItemLike dye) {
